 ...
 * @version   $Id: ComplexRiemannLeftEnd.java 109 2010-06-13 04:26:48Z sugawara $
 * @since   2003/10/10 14:22:47
 * @uml.stereotype   uml_id="null" isDefined="true" name="tagged" 
 */

public class ComplexRiemannLeftEnd implements ComplexIntegral {
   ...
   * 
   */
  public ComplexRiemannLeftEnd(final long numberOfPartitions) {
    try {
      if (numberOfPartitions < 1) {
        throw new IntegralException(
            "The number of partitions must be grater than one.");
      }
  ...
  public Operation setInterval(final Number begin, final Number end) {
    ...
    try {
      if (begin.getClass() != Class.forName("java.lang.Double")) {
        ...
        throw new ClassCastException(
            "The type of independent1 must be java.lang.Double.");
      }
    ...
    ComplexRiemannLeftEnd c = new ComplexRiemannLeftEnd(this.numberOfPartitions);
